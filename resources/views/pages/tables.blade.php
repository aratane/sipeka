                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                ...
                                                <button data-bs-toggle="modal" data-bs-target="#exampleModal"
                                                    ...
                                                    class="text-white btn btn-info font-weight-bold text-xs"
                                                                ...
                                                                <form>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="recipient-name"
                                                                            class="col-form-label">Dokumen
                                                                            Pengajuan</label><br>
                                                                        <button class="btn btn-primary"><a
                                                                                class="text-white"
                                                                                href="download/Pengajuan_Kerja.pdf">Unduh
                                                                                Dokumen</a></button>
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="message-text"
                                                                            class="col-form-label">KRS</label><br>
                                                                        <button class="btn btn-primary"><a
                                                                                class="text-white"
                                                                                href="download/KRS.pdf">Unduh
                                                                                Dokumen</a></button>
                                                                    </div>
                                                                </form>
                                                            </div>
