                ...
                <div class="card ">
                    <div class="card-header pb-0 p-3">
                        <div class="d-flex justify-content-center">
                            <div id="quote" class="mb-2 ini-judul">Selamat Datang Di Aplikasi Sistem Pengajuan Praktek Kerja</div>
                            <script src="">
                                gsap.to(".ini-judul",{
                                    x: 100;
                                    y: 200;
                    ...
                    <div class="card-header col-lg-12">
                        <div class="d-flex justify-content-between gap-4">
                            <h6 class="col-lg-4 custom-subhead-font">Syarat Dan Ketentuan Pengajuan Praktek Kerja</h6>
      ...
      <label for="s1" id="slide1">
        <div class="card row">
          ...
          <div class="infos p-0 col-7">
            ...
            <span class="lorem">Mahasiswa telah melakukan pengisian KRS (Kartu Rencana Studi) dan telah di approve dosen wali yang bersangkutan</span>
          </div>
          
          
        <div class="infos p-0 col-4 ">
            
            <img class="imejii " src="assets/img/bg-profile.jpg" alt="" sizes="cover" width="170px" height="40rem">
          </div></div>
      </label>
      ...
      <label for="s2" id="slide2">
        <div class="card">
          ...
          <div class="infos p-0">
            ...
            <span class="lorem">Mahasiswa diharuskan lulus di mata kuliahnya terlebih dahulu</span>
          </div>
...
<div class="card-header col-lg-12">
    <form method="" action="">
        <div class="d-flex justify-content-between gap-5">
                ...
                <div class="flex flex-row -mx-3 justify-center">
                  <div class="bg-black files-icons flex-none max-w-full px-3">
                    <div>
                      ...
                      <h6 class="mb-2 font-bold text-center dark:text-white"></h6>
                ...
                <div class="flex flex-row -mx-3 justify-center">
                  <div class="flex-none w-2/3 max-w-full px-3 ">
                    <div>
                            ...
                            <h6 class="mb-2 font-bold text-center dark:text-white">Drag and drop files,or <input class="custom-file-input" type="file" id="file" aria-label="File browser example" placeholder="some files"></h6>
            ...
            </div><h6 class="col-lg-4 custom-subhead-font text-right">Upload Dokumen Pengajuan Praktek Kerja</h6>
                        
    

  </div><input class="btn btn-primary float-right mt-5 col-12" type="submit" name="Upload" placeholder="Upload" value="Upload">
    </form>
                        </div>
                        @elsecan('isKaprodi')
                        <div class="row">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center text-sm">
                                        ...
                                        <label class="badge bg-danger badge-danger">TIDAK LULUS</label>
                                        <label class="badge bg-success badge-success">LULUS</label>
