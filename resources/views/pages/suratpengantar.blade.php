...
<body onload="window.print()">
    ...
    <div>
        ...
        <p>Sehubungan dengan adanya tugas kerja praktek yang akan diikuti oleh mahasiswa Fakultas Teknik Universitas
            Contoh, dengan ini kami bermaksud untuk memberikan surat pengantar kerja praktek bagi mahasiswa tersebut.
        </p>
        ...
        <p>Kami berharap Bapak/Ibu dapat memberikan kesempatan kepada mahasiswa kami untuk dapat mengikuti kerja praktek
